...
class AccuracyCalculator:
    ...
    def calculate_recall_at_3(self, knn_labels, query_labels, **kwargs):
        return recall_at_k(knn_labels, query_labels[:, None], 3)

    def calculate_recall_at_5(self, knn_labels, query_labels, **kwargs):
        return recall_at_k(knn_labels, query_labels[:, None], 5)
